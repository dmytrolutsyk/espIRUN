...
#define ESPDATA_UUID              "df342b03-53f9-43b4-acb6-62a63ca0615a"
...
BLECharacteristic *pCharESPData;
...
void setup() {
  ...
  // add
  pCharESPData = pService->createCharacteristic(ESPDATA_UUID, BLECharacteristic::PROPERTY_READ );
  pCharESPData->setValue("salut c'est moi");
  // end add
